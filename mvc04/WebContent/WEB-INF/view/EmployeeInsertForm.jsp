				...
				<table>
					...
					<tr>
						...
						<td><input type="text" id="ssn1" name="ssn1"
							...
							type="text" id="ssn2" name="ssn2" style="width: 110px;"
					...
					<tr>
						...
						<td><input type="text" id="basicPay" name="basicPay">
							(최소 기본급: <span id="minBasicPay" style="color: red; font-weight: bold;">0</span>원)</td>
					</tr>
					<tr>
						<th>수당</th>
					...
					<tr>
						<td colspan="2" align="center"><br /> <br />
							...
							<button type="button" id="listBtn" class="btn" style="width: 40%">직원
