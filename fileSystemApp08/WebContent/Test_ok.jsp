...
<%
	...
	String savePath = root + "pds" + File.separator + "savaFile";
	
	System.out.println(savePath);
	//--==>> C:\SpringMVCStudy\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\fileSystemApp08\pds\savaFile
	...
	try
	{
		...
		// check~!!!
		// MulipartRequest 객체의 『getFileNames()』
		...
		while(files.hasMoreElements())
		{
			...
			if(req.getFilesystemName(name) != null)
			{
				...
				if(f != null)
				{
					out.println("파일 크기: " + f.length() + "Bytes. <br><br>");
				}
			}
		}
